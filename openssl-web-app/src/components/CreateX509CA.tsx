...
export default function CreateX509CA({ formData, onFormDataChange, privKey }) {
    ...
    return (
        <div className="p-4 bg-white bg-opacity-90 rounded shadow">
            <p className="text-lg font-medium text-gray-700">Issue a CA certificate with your connected key</p>
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button type="submit" className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Copy X.509 certificate to clipboard</button>
            </form>
        </div>
    );
}